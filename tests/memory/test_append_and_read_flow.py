...
def test_append_and_recent_turns_returns_newest_first(log_dir):
...
def test_recent_turns_respects_limit(log_dir):
...
def test_recent_turns_empty_session_returns_empty_list(log_dir):
...
def test_singleton_returns_same_instance(log_dir):
